...
class BranchProfile:
    ...
    def __init__(self) -> None:
        self.branch_line = None
        self.branch_true_side_line = None
        self.branch_false_side_line = None
...
def load_all_branch_profiles(target_folder: str) -> List[BranchProfile]:
    all_branch_profiles = {}
    data_files = fuzz_utils.get_all_files_in_tree_with_regex(target_folder, ".*branchProfile\.yaml$")
